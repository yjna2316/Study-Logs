...
class ConditionalOnClassTest {
    ...
    companion object {
        const val CLASSPATH_KLASS_A = "com.kopring.studylogs.springboot.conditional.KlassA"
        const val CLASSPATH_KLASS_B = "com.kopring.studylogs.springboot.conditional.KlassB"
    }
}
